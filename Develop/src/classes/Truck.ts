...
class Truck extends Vehicle {
  ...
  tow(vehicle: Truck | Motorbike | Car): void {
    ...
    override printDetails(): void {
      ...
      console.log(`Top Spead: ${this.topSpeed}`);
      console.log(`color: ${this.color}`);
      console.log(`Towing capacity: ${this.towingCapacity}`);
      console.log(`Wheels: ${this.wheels}`);

      console.log(
        `🛞 1: ${this.wheels[0].getDiameter} inch with a ${this.wheels[0].getTireBrand} tire`
      );
      console.log(
        `🛞 2: ${this.wheels[1].getDiameter} inch with a ${this.wheels[1].getTireBrand} tire`
      );
      console.log(
        `🛞 3: ${this.wheels[2].getDiameter} inch with a ${this.wheels[2].getTireBrand} tire`
      );
      console.log(
        `🛞 4: ${this.wheels[3].getDiameter} inch with a ${this.wheels[3].getTireBrand} tire`
      );
    }
